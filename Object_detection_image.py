...
# Use python3 object_detection_image.py --image [image name]
...
flags = tf.app.flags
flags.DEFINE_string('image', '', 'Path to the input image')
FLAGS = flags.FLAGS
...
# Path to image
PATH_TO_IMAGE = os.path.join(CWD_PATH,FLAGS.image)
