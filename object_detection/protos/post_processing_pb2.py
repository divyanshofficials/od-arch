...
# source: protos/post_processing.proto
...
BatchNonMaxSuppression = _reflection.GeneratedProtocolMessageType('BatchNonMaxSuppression', (_message.Message,), dict(
  ...
  __module__ = 'protos.post_processing_pb2'
